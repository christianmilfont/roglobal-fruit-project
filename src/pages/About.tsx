    ...
    <div className="min-h-screen">
      ...
      <main className="pt-20 sm:pt-24">
        ...
        <section className="section-padding relative overflow-hidden">
          ...
          {/* Decorativo leve (sem blur pesado) */}
          <div className="absolute -top-40 -right-40 w-96 h-96 bg-primary/5 rounded-full opacity-30" />
          <div className="absolute -bottom-20 -left-20 w-72 h-72 bg-secondary/5 rounded-full opacity-30" />
          ...
          <div className="container-narrow max-w-4xl relative">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold text-foreground mt-4 mb-4">
                Sobre a <span className="italic text-gradient">Rochelle</span>
              </h1>
            ...
            >
              <div className="card-premium p-8 lg:p-12">
                <div className="flex flex-col md:flex-row gap-8 items-start mb-8">
                  ...
                  >
                    <div className="w-48 h-48 lg:w-56 lg:h-56 rounded-2xl overflow-hidden shadow-card ring-2 ring-primary/10">
                      <img
                        src={rochellePhoto}
                        alt="Rochelle - Fundadora da RSFruit Connect"
                        className="w-full h-full object-cover object-center"
                        loading="lazy"
                      />
                    </div>

                    <p className="text-center mt-3 font-display font-semibold text-foreground text-sm">
                      Rochelle
                    </p>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-lg font-body text-muted-foreground leading-relaxed mb-6">
                      ...
                      pequenos e médios produtores brasileiros e compradores internacionais.
                    </p>

                    <p className="text-lg font-body text-muted-foreground leading-relaxed">
                      Hoje, a empresa atua em diversos mercados, mantendo como essência a conexão humana, o cuidado com a qualidade e o compromisso com todos os envolvidos.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {highlights.map((h, i) => (
                  <motion.div
                    ...
                    className="inline-flex items-center gap-2 bg-primary/10 text-primary px-5 py-2.5 rounded-full font-body font-medium text-sm"
                  >
