...
const testimonials = [
  {
    text: "A RoFruit Connect transformou a forma como exportamos nossas mangas. Profissionalismo e cuidado em cada detalhe.",
    author: "Carlos Silva",
    role: "Produtor — Bahia",
    stars: 5,
  },
...
const Trust = () => {
  return (
    <section className="section-padding gradient-section-bg relative overflow-hidden">
      {/* Decorative */}
      <div className="absolute -top-20 right-0 w-72 h-72 bg-secondary/5 blob animate-blob-morph blur-2xl" />
      ...
      <div className="container-narrow relative">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold text-foreground mt-4">
            Confiança e <span className="italic text-gradient-warm">Credibilidade</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8 mb-24">
          {values.map((v, i) => (
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-primary-glow flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:shadow-glow transition-all duration-300">
          ...
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary to-primary-glow flex items-center justify-center text-primary-foreground font-display font-bold text-sm">
                  {t.author[0]}
                </div>
                <div>
